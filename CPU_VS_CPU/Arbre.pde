...
public ArrayList<Arbre> Ar;
    ...
    public Arbre(int movement,int Score1,int Score2 ,pawn paw ,int nb, int s1 ,int s2 ,int x , int y,int r,int WP )     
   {    Ar =new ArrayList<Arbre>() ;
        ...
        heuristique(nb,paw.x, paw.y, x ,y, WP) ;                  
        pwse = paw ;
        this.movement = movement ;
        this.nb =nb;
   }
   public Arbre(){}   
  public void heuristique(int nb,int xanc,int yanc, int xn ,int yn ,int WP ) 
  {  valeur =0 ;
    int centrexanc ;
    int centreyanc ;
    int centrexn ;
